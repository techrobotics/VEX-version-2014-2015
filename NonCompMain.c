...
#pragma config(Motor,  port1,           rDrive,        tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_2, 1000)
...
#pragma config(Motor,  port10,          lDrive,        tmotorVex393, openLoop, encoder, encoderPort, I2C_1, 1000)
